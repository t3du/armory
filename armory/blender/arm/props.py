...
def init_properties():
    ...
    bpy.types.World.arm_project_html5_popupmenu_in_browser = BoolProperty(name="Disable Browser Context Menu", description="Disable the browser context menu for the canvas element on the page", default=True, update=assets.invalidate_compiler_cache)
    # Windows Settings
    ...
    bpy.types.World.arm_dce = BoolProperty(name="DCE", description="Enable dead code elimination", default=False, update=assets.invalidate_compiler_cache)
    bpy.types.World.arm_asset_compression = BoolProperty(name="Asset Compression", description="Enable scene data compression with LZ4. Warning: This will slow down export!", default=False, update=assets.invalidate_compiler_cache)
    ...
    bpy.types.Object.arm_soft_body_damping = FloatProperty(name="Soft Body Damping", description="Damping", default=0.01)
    bpy.types.Object.arm_soft_body_angular_stiffness = FloatProperty(name="Soft Body Angular Stiffness", description="Angular Stiffness", default=0.9)
    bpy.types.Object.arm_soft_body_pressure = FloatProperty(name="Soft Body Pressure", description="Pressure", default=0.0)
    ...
    bpy.types.Curve.arm_draw_strength = FloatProperty(name="Draw Strength", default=0.005)
    bpy.types.Curve.arm_draw_color = FloatVectorProperty(name="Draw Color", size=4, default=[0,0,0,1], subtype='COLOR', min=0, max=1)
